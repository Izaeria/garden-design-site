...
import gardenImg from "../assets/AboutPageImages/about-garden-image.png";
      ...
      <div className="about-page-sections">
        <section className="about-page-card">
          ...
          <p className="about-page-card-text">
            ...
            hur utemiljöer kan planeras för att passa både platsen och
        ...
        <section className="about-page-card">
          ...
          <p className="about-page-card-text">
            Jag arbetar med helheten: växtval, material, rumslighet och känslan
            på platsen. Målet är att skapa trädgårdar som känns personliga,
